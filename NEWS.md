...
- Add functionality that allows to read any data source at any point in time, even after splitting. In this case, the read data is automatically cut to the corresponding range on the 'RangeData' object (PR #201, 95522d27178faeee73c11014bb9561d48227399b)´. Additionally, changing the configuration parameters concerning additional data sources, the environment of a 'ProjectData' object is no longer reset (PR #201, 364b3a255d2124d1e07cd6cfa295209dcf3806f8).
