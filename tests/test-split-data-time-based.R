...
patrick::with_parameters_test_that("Split a data object time-based (split.basis = 'commits').", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2016-07-12 15:58:59-2016-07-12 16:01:59" = data$issues[rownames(data$issues) %in% c(1:3, 28:31, 64), ],
            "2016-07-12 16:01:59-2016-07-12 16:04:59" = data$issues[rownames(data$issues) %in% c(17, 42:44, 65), ],
            "2016-07-12 16:04:59-2016-07-12 16:06:33" = data$issues[rownames(data$issues) %in% c(4, 32, 38:39), ]
        ),
        mails = list(
...
patrick::with_parameters_test_that("Split a data object time-based (split.basis = 'mails').", {
    ...
    expected.data = list(
        ...
        issues = list(
            ...
            "2010-10-10 06:38:13-2013-10-10 00:38:13" = data$issues[rownames(data$issues) %in% 47:59, ],
            "2013-10-10 00:38:13-2016-07-12 16:05:38" = data$issues[rownames(data$issues) %in% c(1:3, 15:17, 28:31, 36:39, 42:44, 64:65), ]
        ),
        mails = list(
            ## comments indicate row names when pasta is not configured
            ...
            "2013-10-10 00:38:13-2016-07-12 16:05:38" = data$mails[13:16, ] # rownames(data$mails) %in% 13:16
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object time-based (split.basis = 'issues').", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2013-04-21 23:52:09-2015-04-22 11:52:09" = data$issues[rownames(data$issues) %in% 47:59, ],
            "2015-04-22 11:52:09-2017-04-21 23:52:09" = data$issues[rownames(data$issues) %in% c(1:22, 25:44, 64:69), ],
            "2017-04-21 23:52:09-2017-05-23 12:32:40" = data$issues[rownames(data$issues) %in% c(23:24, 60:63), ]
        ),
        mails = list(
            "2013-04-21 23:52:09-2015-04-22 11:52:09" = data$mails[0, ],
            "2015-04-22 11:52:09-2017-04-21 23:52:09" = data$mails[13:16, ], # when pasta is not configured: rownames(data$mails) %in% 13:16
...
patrick::with_parameters_test_that("Split a data object time-based (split.basis = 'commits', sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2016-07-12 15:58:59-2016-07-12 16:01:59" = data$issues[rownames(data$issues) %in% c(1:3, 28:31, 64), ],
            "2016-07-12 16:00:29-2016-07-12 16:03:29" = data$issues[rownames(data$issues) %in% c(31, 42:44, 64:65), ],
            "2016-07-12 16:01:59-2016-07-12 16:04:59" = data$issues[rownames(data$issues) %in% c(17, 42:44, 65), ],
            "2016-07-12 16:03:29-2016-07-12 16:06:29" = data$issues[rownames(data$issues) %in% c(17, 32, 38:39), ],
            "2016-07-12 16:04:59-2016-07-12 16:06:33" = data$issues[rownames(data$issues) %in% c(4, 32, 38:39), ]
        ),
        mails = list(
            ## comments indicate row names when pasta is not configured
            ...
            "2016-07-12 16:01:59-2016-07-12 16:04:59" = data$mails[15, ], # rownames(data$mails) == 15
            "2016-07-12 16:03:29-2016-07-12 16:06:29" = data$mails[15:16, ], # rownames(data$mails) %in% c(15,16)
            "2016-07-12 16:04:59-2016-07-12 16:06:33" = data$mails[16, ] # rownames(data$mails) == 16
        ),
        pasta = list(
            "2016-07-12 15:58:59-2016-07-12 16:01:59" = data$pasta,
...
patrick::with_parameters_test_that("Split a data object time-based (split.basis = 'mails', sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        issues = list(
            ...
            "2010-10-10 06:38:13-2013-10-10 00:38:13" = data$issues[rownames(data$issues) %in% 47:59, ],
            "2012-04-10 03:38:13-2015-04-10 21:38:13" = data$issues[rownames(data$issues) %in% 47:59, ],
            "2013-10-10 00:38:13-2016-07-12 16:05:38" = data$issues[rownames(data$issues) %in% c(1:3, 15:17, 28:31, 36:39, 42:44, 64:65), ]
        ),
        mails = list(
            ## comments indicate row names when pasta is not configured
...
patrick::with_parameters_test_that("Split a data object time-based (split.basis = 'issues', sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        issues = list(
            ...
            "2015-04-22 11:52:09-2017-04-21 23:52:09" = data$issues[rownames(data$issues) %in% c(1:22, 25:44, 64:69), ],
            "2016-04-21 17:52:09-2017-05-23 12:32:40" = data$issues[rownames(data$issues) %in% c(1:44, 60:69), ]
        ),
        mails = list(
            ## comments indicate row names when pasta is not configured
            "2013-04-21 23:52:09-2015-04-22 11:52:09" = data$mails[0, ],
            "2014-04-22 05:52:09-2016-04-21 17:52:09" = data$mails[0, ],
            "2015-04-22 11:52:09-2017-04-21 23:52:09" = data$mails[13:16, ], # rownames(data$mails) %in% 13:17
            "2016-04-21 17:52:09-2017-05-23 12:32:40" = data$mails[13:16, ]  # rownames(data$mails) %in% 13:17
        ),
        pasta = list(
            "2013-04-21 23:52:09-2015-04-22 11:52:09" = data$pasta,
...
patrick::with_parameters_test_that("Split a data object time-based (bins = ... ).", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2016-01-01 00:00:00-2016-12-31 23:59:59" = data$issues[rownames(data$issues) %in% c(1:22, 25:44, 64:69), ]
        ),
        mails = list(
...
patrick::with_parameters_test_that("Split a data object time-based (bins = ... , sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2016-01-01 00:00:00-2016-12-31 23:59:59" = data$issues[rownames(data$issues) %in% c(1:22, 25:44, 64:69), ],
            "2016-12-31 23:59:59-2017-06-03 03:03:03" = data$issues[rownames(data$issues) %in% c(23:24, 60:63), ]
        ),
        mails = list(
            "2016-01-01 00:00:00-2016-12-31 23:59:59" = data$mails[rownames(data$mails) %in% 13:17, ],
...
patrick::with_parameters_test_that("Split a data object time-based using custom event timestamps.", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2016-07-12 15:00:00-2016-07-12 16:00:00" = data$issues[rownames(data$issues) %in% c(1:3, 15:16, 28:30), ],
            "2016-07-12 16:00:00-2016-07-12 16:05:00" = data$issues[rownames(data$issues) %in% c(17, 31, 38:39, 42:44, 64:65), ],
            "2016-07-12 16:05:00-2016-08-08 00:00:00" = data$issues[rownames(data$issues) %in% c(4:5, 8:14, 25:27, 32:35, 40:41, 66:69), ],
            "2016-08-08 00:00:00-2016-10-05 09:00:00" = data$issues[rownames(data$issues) %in% c(6, 18), ]
        ),
        mails = list(
            ## comments indicate rownames when pasta is not configured
            "2016-07-12 15:00:00-2016-07-12 16:00:00" = data$mails[13:14, ], # rownames(data$mails) %in% 13:14
            "2016-07-12 16:00:00-2016-07-12 16:05:00" = data$mails[15, ],    # rownames(data$mails) %in% 15
            "2016-07-12 16:05:00-2016-08-08 00:00:00" = data$mails[16, ],    # rownames(data$mails) %in% 16
...
patrick::with_parameters_test_that("Split a data object time-based with equal-sized windows (number.windows = ..., split.basis = 'commits').", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2016-07-12 15:58:59-2016-07-12 16:01:30" = data$issues[rownames(data$issues) %in% c(1:3, 28:31), ],
            "2016-07-12 16:01:30-2016-07-12 16:04:01" = data$issues[rownames(data$issues) %in% c(17, 42:44, 64:65), ],
            "2016-07-12 16:04:01-2016-07-12 16:06:33" = data$issues[rownames(data$issues) %in% c(4, 32, 38:39), ]
        ),
        mails = list(
            "2016-07-12 15:58:59-2016-07-12 16:01:30" = data$mails[0, ],
            "2016-07-12 16:01:30-2016-07-12 16:04:01" = data$mails[0, ],
            "2016-07-12 16:04:01-2016-07-12 16:06:33" = data$mails[15:16, ] # when pasta is not configured: rownames(data$mails) %in% 15:16
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object time-based with equal-sized windows (number.windows = ..., split.basis = 'mails').", {
    ...
    expected.data = list(
        ...
        issues = list(
            ...
            "2010-08-26 17:21:55-2013-08-04 04:43:46" = data$issues[rownames(data$issues) %in% 47:59, ],
            "2013-08-04 04:43:46-2016-07-12 16:05:38" = data$issues[rownames(data$issues) %in% c(1:3, 15:17, 28:31, 36:39, 42:44, 64:65), ]
        ),
        mails = list(
            ## comments indicate row names when pasta is not configured
            ...
            "2013-08-04 04:43:46-2016-07-12 16:05:38" = data$mails[13:16, ] # rownames(data$mails) %in% 13:16
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object time-based with equal-sized windows (number.windows = ..., split.basis = 'issues').", {
    ...
    expected.data = list(
        ...
        issues = list(
            "2013-04-21 23:52:09-2014-09-01 12:05:39" = data$issues[rownames(data$issues) %in% 47:59, ],
            "2014-09-01 12:05:39-2016-01-12 00:19:09" = data$issues[0, ],
            "2016-01-12 00:19:09-2017-05-23 12:32:40" = data$issues[rownames(data$issues) %in% c(1:44, 60:69), ]
        ),
        mails = list(
            "2013-04-21 23:52:09-2014-09-01 12:05:39" = data$mails[0, ],
            "2014-09-01 12:05:39-2016-01-12 00:19:09" = data$mails[0, ],
            "2016-01-12 00:19:09-2017-05-23 12:32:40" = data$mails[13:16, ] # when pasta is not configured: rownames(data$mails) %in% 13:16
        ),
        pasta = list(
