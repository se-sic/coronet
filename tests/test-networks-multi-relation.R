...
test_that("Network construction of the undirected author network with relation = c('cochange', 'mail')", {
    ...
    ## edge attributes
    data = data.frame(comb.1. = c("Björn", "Björn", "Olaf", "Olaf", "Olaf", "Olaf", "Karl", "Karl", "Björn", "Björn", "Olaf",  "Olaf"),
                      comb.2. = c("Olaf", "Olaf", "Karl", "Karl", "Thomas", "Thomas", "Thomas", "Thomas", "Olaf", "Olaf", "Thomas", "Thomas"),
                      date = get.date.from.string(c("2016-07-12 15:58:59", "2016-07-12 16:00:45", "2016-07-12 16:05:41", "2016-07-12 16:06:10",
                                                    ...
                                                    "2016-07-12 15:58:40", "2016-07-12 15:58:50", "2016-07-12 16:04:40", "2016-07-12 16:05:37")),
                      hash = c("72c8dd25d3dd6d18f46e2b26a5f5b1e2e8dc28d0", "5a5ec9675e98187e1e92561e1888aa6f04faa338", "3a0ed78458b3976243db6829f63eba3eead26774",
                               ...
                               "1143db502761379c2bfcecc2007fc34282e7ee61", "0a1a5c523d835459c42f33e863623138555e2526", rep(NA, 4)),
                      file = c("test.c", "test.c", "test2.c", "test3.c", "test2.c", "test2.c", "test3.c", "test2.c", rep(NA, 4)),
                      artifact.type = c("Feature", "Feature", "Feature", "Feature", "Feature", "Feature", "Feature", "Feature", rep("Mail", 4)),
                      artifact = c("A", "A", "Base_Feature", "Base_Feature", "Base_Feature", "Base_Feature", "Base_Feature", "Base_Feature", rep(NA, 4)),
                      weight = 1,
                      type = TYPE.EDGES.INTRA,
                      relation = c("cochange", "cochange", "cochange", "cochange", "cochange", "cochange", "cochange", "cochange", rep("mail", 4)),
                      message.id = c(NA, NA, NA, NA, NA, NA, NA, NA, "<4cbaa9ef0802201124v37f1eec8g89a412dfbfc8383a@mail.gmail.com>",
                      ...
                      thread = c(NA, NA, NA, NA, NA, NA, NA, NA, "<thread-8>", "<thread-8>", "<thread-9>", "<thread-9>")
    )
...
test_that("Construction of the bipartite network for the feature artifact with author.relation = c('cochange', 'issue') and artifact.
    ...
    network.expected.data = data.frame(
                  from = c("Björn", "Björn", "Björn", "Björn", "Björn", "Björn", "Björn", "Björn", "Karl", "Max",
                           "Olaf", "Olaf", "Olaf", "Thomas", "Thomas", "Björn", "Björn", "Björn",  "Fritz fritz@example.org",
                           "georg", "Hans", "Hans", "Hans", "Hans", "Hans", "Hans", "Hans", "Olaf", "Olaf", "Thomas", "udo"),
                  to   = c("<issue-51>", "<issue-48>", "<issue-51>", "<issue-51>", "<issue-51>", "<issue-51>", "<issue-57>", "<issue-57>",
                           "<issue-2>", "<issue-57>", "<issue-48>", "<issue-51>", "<issue-51>", "<issue-48>", "<issue-48>",
                           "<thread-1>",
                           "<thread-2>", "<thread-8>", "<thread-4>", "<thread-5>", "<thread-6>", "<thread-6>", "<thread-6>", "<thread-6>",
                           "<thread-6>", "<thread-6>", "<thread-7>", "<thread-8>", "<thread-9>", "<thread-9>", "<thread-3>"),
                  ...
                  issue.id = c("<issue-51>", "<issue-48>", "<issue-51>", "<issue-51>", "<issue-51>",
                               ...
                               "<issue-48>", "<issue-51>", "<issue-51>", "<issue-48>", "<issue-48>", rep(NA,16)),
                  event.name = c("commented", "commented", "commented", "commented", "commented",
                                 "commented", "commented", "commented", "commented", "commented",
                                 "commented", "commented", "commented", "commented", "commented", rep(NA, 16)),
                  ...
                  message.id = c(rep(NA, 15),
                                 ...
                                 "<4cbaa9ef0802201124v37f1eec8g89a412dfbfc8383a@mail.gmail.com>", "<jlkjsdgihwkfjnvbjwkrbnwe@mail.gmail.com>",
                                 "<dfhglkjdgjkhnwrd@mail.gmail.com>", "<hans1@mail.gmail.com>",
                  ...
                  thread = c(rep(NA, 15),
                             "<thread-1>", "<thread-2>", "<thread-8>", "<thread-4>", "<thread-5>", "<thread-6>", "<thread-6>", "<thread-6>",
                             "<thread-6>", "<thread-6>", "<thread-6>", "<thread-7>", "<thread-8>", "<thread-9>", "<thread-9>", "<thread-3>")
    )
...
test_that("Construction of the multi network for the feature artifact with author.relation = c('cochange', 'mail') and artifact.
    ...
    edges = data.frame(from = c("Björn", "Björn", "Olaf", "Olaf", "Olaf", "Olaf", "Karl", "Karl", "Björn", "Björn",
                                "Olaf", "Olaf", "Base_Feature", "Base_Feature", "Björn", "Olaf", "Olaf", "Karl", "Thomas",
                                "Thomas", rep("Björn",8), rep("Olaf",3), "Karl", "Thomas", "Thomas"),
                       to = c("Olaf", "Olaf", "Karl", "Karl", "Thomas", "Thomas", "Thomas", "Thomas", "Olaf", "Olaf",
                              "Thomas", "Thomas","foo", "foo", "A", "A", "Base_Feature", "Base_Feature", "Base_Feature", "foo",
                              "<issue-51>", "<issue-48>", rep("<issue-51>", 4), rep("<issue-57>", 2), "<issue-48>",
                              rep("<issue-51>", 2), "<issue-2>", rep("<issue-48>", 2)),
                       date = get.date.from.string(c("2016-07-12 15:58:59", "2016-07-12 16:00:45", "2016-07-12 16:05:41", ## author cochange
                                                     ...
                                                     "2016-07-12 16:05:37",
                                                     "2016-07-12 16:06:32", "2016-07-12 16:06:32", "2016-07-12 15:58:59", ## bipartite cochange
                                                     "2016-07-12 16:00:45", "2016-07-12 16:05:41", "2016-07-12 16:06:10",
                        ...
                        file = c("test.c", "test.c", "test2.c", "test3.c", "test2.c", "test2.c", "test3.c", "test2.c",
                                 ...
                                 rep(NA, 14)),
                        artifact.type = c(rep("Feature",8), rep("Mail", 4), rep("Feature",8), rep("Issue", 14)),
                        artifact = c("A", "A", "Base_Feature", "Base_Feature", "Base_Feature", "Base_Feature", "Base_Feature", "Base_Feature",
                                     rep(NA, 4),
                                     "Base_Feature", "foo", "A", "A", "Base_Feature", "Base_Feature", "Base_Feature", "foo",
                                     rep(NA, 14)),
                        weight = 1,
                        type = c(rep(TYPE.EDGES.INTRA, 14), rep(TYPE.EDGES.INTER, 20)),
                        relation = c(rep("cochange", 8), rep("mail", 4), rep("cochange", 8), rep("issue", 14)),
                        message.id = c(rep(NA, 8),
                                       ...
                                       rep(NA, 22)),
                        thread = c(rep(NA, 8), "<thread-8>", "<thread-8>", "<thread-9>", "<thread-9>", rep(NA, 22)),
                        issue.id = c(rep(NA, 20), "<issue-51>", "<issue-48>","<issue-51>", "<issue-51>", "<issue-51>",
