...
patrick::with_parameters_test_that("Split a data object activity-based (activity.amount = ..., activity.type = 'commits').", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2016-07-12 15:58:59-2016-07-12 16:06:10" = data$mails[15:16, ],
    ...
    expected.data = list(
        ...
        mails = list(
            "2016-07-12 15:58:59-2016-07-12 16:06:33" = data$mails[15:16, ]
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object activity-based (activity.amount = ..., activity.type = 'mails').", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2004-10-09 18:38:13-2010-07-12 11:05:35" = data$mails[1:3, ],
            "2010-07-12 11:05:35-2010-07-12 12:05:41" = data$mails[4:6, ],
            "2010-07-12 12:05:41-2010-07-12 12:05:44" = data$mails[7:9, ],
            "2010-07-12 12:05:44-2016-07-12 15:58:40" = data$mails[10:12, ],
            "2016-07-12 15:58:40-2016-07-12 16:05:37" = data$mails[13:15, ],
            "2016-07-12 16:05:37-2016-07-12 16:05:38" = data$mails[16, ]
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object activity-based (activity.amount = ..., activity.type = 'issues').", {
    ...
    expected.data = list(
        ...
        mails = list(
            ...
            "2013-05-25 06:22:23-2016-07-12 15:59:59" = data$mails[13:14, ],
            "2016-07-12 15:59:59-2016-07-12 16:06:30" = data$mails[15:16, ],
    ...
    expected.data = list(
        ...
        mails = list(
            "2013-04-21 23:52:09-2017-05-23 12:32:40" = data$mails[13:16, ]
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object activity-based (activity.type = 'commits', sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2016-07-12 15:58:59-2016-07-12 16:06:10" = data$mails[15:16, ],
            "2016-07-12 16:00:45-2016-07-12 16:06:20" = data$mails[15:16, ],
            "2016-07-12 16:06:10-2016-07-12 16:06:32" = data$mails[0, ],
...
patrick::with_parameters_test_that("Split a data object activity-based (activity.type = 'mails', sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2004-10-09 18:38:13-2010-07-12 11:05:35" = data$mails[1:3, ],
            "2005-02-09 18:49:49-2010-07-12 12:05:34" = data$mails[2:4, ],
            "2010-07-12 11:05:35-2010-07-12 12:05:41" = data$mails[4:6, ],
            "2010-07-12 12:05:34-2010-07-12 12:05:42" = data$mails[5:7, ],
            "2010-07-12 12:05:41-2010-07-12 12:05:44" = data$mails[7:9, ],
            "2010-07-12 12:05:42-2010-07-12 12:05:45" = data$mails[8:10, ],
            "2010-07-12 12:05:44-2016-07-12 15:58:40" = data$mails[10:12, ],
            "2010-07-12 12:05:45-2016-07-12 15:58:50" = data$mails[11:13, ],
            "2016-07-12 15:58:40-2016-07-12 16:05:37" = data$mails[13:15, ],
            "2016-07-12 15:58:50-2016-07-12 16:05:38" = data$mails[14:16, ]
        ),
        pasta = list(
            "2004-10-09 18:38:13-2010-07-12 11:05:35" = data$pasta,
...
patrick::with_parameters_test_that("Split a data object activity-based (activity.type = 'issues', sliding.window = TRUE).", {
    ...
    expected.data = list(
        ...
        mails = list(
            ...
            "2013-05-25 06:22:23-2016-07-12 15:59:59" = data$mails[13:14, ],
            "2016-07-12 15:30:02-2016-07-12 16:02:02" = data$mails[13:14, ],
            "2016-07-12 15:59:59-2016-07-12 16:06:30" = data$mails[15:16, ],
            "2016-07-12 16:02:02-2016-07-27 20:12:08" = data$mails[15:16, ],
            "2016-07-12 16:06:30-2016-10-05 15:30:02" = data$mails[0, ],
...
patrick::with_parameters_test_that("Split a data object activity-based (number.windows = ..., activity.type = 'commits').", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2016-07-12 15:58:59-2016-07-12 16:06:20" = data$mails[15:16, ],
            "2016-07-12 16:06:20-2016-07-12 16:06:33" = data$mails[0, ]
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object activity-based (number.windows = ..., activity.type = 'mails').", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2004-10-09 18:38:13-2010-07-12 12:05:43" = data$mails[1:8, ],
            "2010-07-12 12:05:43-2016-07-12 16:05:38" = data$mails[9:16, ]
        ),
        pasta = list(
...
patrick::with_parameters_test_that("Split a data object activity-based (number.windows = ..., activity.type = 'issues').", {
    ...
    expected.data = list(
        ...
        mails = list(
            "2013-04-21 23:52:09-2016-07-12 16:02:02" = data$mails[13:14, ],
            "2016-07-12 16:02:02-2017-05-23 12:32:40" = data$mails[15:16, ]
        ),
        pasta = list(
