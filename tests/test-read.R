...
test_that("Read and parse the issue data.", {
    ...
    issue.data.expected = data.frame(issue.id = c(rep("<issue-jira-ZEPPELIN-328>", 14), rep("<issue-jira-ZEPPELIN-332>", 7),
                                                  rep("<issue-github-3>", 8), rep("<issue-github-6>", 10),
                                     ...
                                     issue.title = c(rep("[ZEPPELIN-328] Interpreter page should clarify the % magic syntax for interpreter group.name", 14),
                                                     ...
                                                     rep("Error in construct.networks.from.list for openssl function networks", 8),
                                     ...
                                     closing.date = get.date.from.string(c(rep("2013-05-25 20:02:08", 14), rep(NA, 7),
                                                                           rep("2016-07-12 16:06:30", 8), rep(NA, 10),
                                                                           rep(NA, 6),
                                     ...
                                     event.name = c("created", "commented", "commented", "commented", "commented", "commented",
                                                    ...
                                                    "resolution_updated", "add_link", "referenced_by", "created", "commented", "commented", "commented", "commented",
                                                    "commented", "created", "assigned", "commented", "state_updated", "referenced",
                                                    "referenced", "add_link", "add_link", "mentioned", "subscribed", "commented", "mentioned",
                                                    "subscribed", "mentioned", "subscribed", "labeled", "commented", "referenced_by",
                                     ...
                                     author.name = c("Thomas", "Thomas", "Björn", "Björn", "Björn", "Björn", "Olaf", "Björn",
                                                     ...
                                                     "Max", "Max", "Karl", "Olaf", "Karl", "Olaf", "Karl", "Thomas", "Karl", "Thomas", "udo",
                                                     "udo", "Thomas", "Björn", "Björn", "Björn", "Björn", "Olaf", "Björn",
                                     ...
                                     date = get.date.from.string(c("2013-04-21 23:52:09", "2013-04-21 23:52:09",
                                                                   ...
                                                                   "2013-06-01 06:53:06", "2013-06-01 06:54:00",
                                                                   "2013-06-01 06:54:00", "2016-07-12 16:01:30",
                                                                   ...
                                                                   "2016-07-12 16:06:30", "2016-08-31 16:45:09",
                                     ...
                                     event.info.1 = c("open", "open", "open", "open", "open", "open", "open", "open", "open",
                                                      ...
                                                      "", "open", "closed", "", "", "<issue-github-6>", "<issue-github-2>", "Thomas",
                                                      "Thomas", "open", "Thomas", "Thomas", "udo", "udo", "decided", "open",
                                                      "<issue-github-3>", "open", "open", "closed", "closed", "closed", "open",
                                     ...
                                     issue.source = c(rep("jira", 21), rep("github", 18), rep("github", 14)),
    ...
    issue.data.expected[["event.info.2"]] = I(list(
                                                ...
                                                "", "", "issue", "issue", "thomas@example.org", "thomas@example.org", list(),
                                                "thomas@example.org", "thomas@example.org", "udo@example.org", "udo@example.org",
