...
test_that("Read and parse the issue data.", {
    ...
    issue.data.expected = data.frame(issue.id = sprintf("<issue-%s>", c(rep("ZEPPELIN-328", 13), rep( "ZEPPELIN-332", 6)
                                     ...
                                     issue.type = c(rep("['issue', 'bug']", 13), rep("['issue', 'bug']", 6),
                                                    rep("['issue', 'bug']", 7), rep("['issue', 'bug', 'enhancement']", 10)),
                                     ...
                                     issue.components = c(rep("['GUI', 'Interpreters']", 13), rep("['Interpreters']", 6),
                                                          rep("[]", 7), rep("[]", 10)),
                                     event.type = c("created","commented","commented","commented","commented","commented",
                                     ...
                                     event.date = get.date.from.string(c("2015-09-29 21:44:21","2015-09-29 21:44:21",
                                    ...
                                    event.info.1 = c("open","open","open","open","open","open","open","open","open",
                                     ...
                                     event.info.2 = c("['unresolved']","['unresolved']","['unresolved']","['unresolved']",
                                                      "['unresolved']","['unresolved']","['unresolved']","['unresolved']",
                                                      "['unresolved']","['unresolved']", "['unresolved']","['unresolved']",
                                                      "unresolved","['unresolved']","['unresolved']","['unresolved']",
                                                      "['unresolved']","['unresolved']","['unresolved']","[]","","[]","open",
                                                     "commit","","","thomas@example.org","thomas@example.org","[]",
