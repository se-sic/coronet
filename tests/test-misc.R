...
test_that("Parse range", {
    ...
    expected.output = list(
        parse.date(c("2012-07-10 15:58:00", "2012-07-15 16:02:00")),
        parse.date(c("2012-07-10 00:00:00", "2012-07-15 16:02:00")),
        parse.date(c("2012-07-10 15:58:00", "2012-07-15 00:00:00")),
