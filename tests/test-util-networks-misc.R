...
test_that("getting a sparse adjacencyy matrix for a network, single edge, no overlap in author list", {
...
test_that("getting a sparse adjacencyy matrix for a network, four edges, more authors than network", {
